 ...
 * queue.
 *
 * A reference to the element is added to the queue container and the size is
 * increased by 1. Time complexity: O(1).
 *
 * @param q A pointer to the queue.
 ...
 * a queue.
 *
 * A reference to the element is returned and the size is decreased by 1. Time
 * complexity: O(1).
 *
 ...
 *
 * Note that the function returns 0 if it is called with a NULL pointer.
 *
 * @param q A pointer to the queue.
 *
